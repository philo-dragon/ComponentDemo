...
public class MyRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    public static final int LARGE = MyProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = MyProgressDrawable.DEFAULT;
    ...
    public void setSize(int size) {
        if (size != MyProgressDrawable.LARGE && size != MyProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == MyProgressDrawable.LARGE) {
    ...
    private void createProgressView() {
        ...
        mProgress = new MyProgressDrawable(getContext(), this);
    ...
    /**
     * Set a callback to override {@link MyRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link MyRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link MyRefreshLayout#canChildScrollUp()} method
