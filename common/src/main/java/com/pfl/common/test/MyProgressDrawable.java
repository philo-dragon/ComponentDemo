 ...
 */
class MyProgressDrawable extends Drawable implements Animatable {
    ...
    MyProgressDrawable(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link MyProgressDrawable.LARGE} or
     *            {@link MyProgressDrawable.DEFAULT}
     */
